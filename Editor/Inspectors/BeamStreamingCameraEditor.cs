...
namespace BeamXR.Streaming.Editor
{
    ...
    {
        private BeamStreamingCamera _streamingCamera = null;
        ...
        private SerializedProperty _transformToFollow;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_streamingCamera.CameraRenderMethod == BeamStreamingCamera.CameraMethod.RenderTexture)
            {
        ...
        private void OnEnable()
        {
            if (Application.isPlaying && !_renderering)
            {
                ...
                {
                    _streamingCamera = serializedObject.targetObject as BeamStreamingCamera;
                }
                if(_streamingCamera != null)
                {
        ...
        private void SecondaryCamera()
        {
            ...
            if (GUILayout.Button(new GUIContent("Camera Settings Guide", "View our docs to see what each of the camera settings do and suggested use-cases.")))
            {
